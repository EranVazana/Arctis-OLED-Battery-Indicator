...
var versionsToSkip = [0, 1, 2, 3, 4, 5, 7, 9, 11];
...
function getV3GitRelease(options) {
    return getJson('https://api.github.com/repos/nexe/nexe/releases/7567580/', options);
}
exports.getV3GitRelease = getV3GitRelease;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, getV3GitRelease(options)];
                case 2:
